...
class FollowersFragment : Fragment(R.layout.fragment_follow) {
    ...
    private val mainViewModel by viewModels<FollowersViewModel>()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        showLoading(true)
        mainViewModel.setListFollowers(username)
        mainViewModel.getListFollowers().observe(viewLifecycleOwner) {
            if (it != null) {
                adapter.setList(it)
                showLoading(false)
            }
